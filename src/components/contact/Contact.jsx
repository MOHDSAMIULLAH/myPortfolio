      ...
      <div className="container contact__container">
        <div className="contact__options">
          <aricle className="contact__option">
            ...
            <a href="mailto:samiullah0813@gmail.com" target="_blank">Send a message</a>            
          </aricle>
          ...
          <aricle className="contact__option">
            ...
            <h4>whatsapp</h4>
            <h5>+917428098866</h5>
            <a href="https://api.whatsapp.com/send?phone=+917428098866" target="_blank">Send a message</a>            
          </aricle>
          </div>
